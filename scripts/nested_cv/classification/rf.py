        ...
        for outer_train_idx, outer_test_idx in outer_cv.split(X, y):
            ...
            def objective(trial, X_resampled, y_resampled):
                ...
                clf = RandomForestClassifier(
                    ...
                    min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf, class_weight=class_weight, n_jobs=6
                )
                ...
                for inner_train_idx, inner_test_idx in inner_cv.split(X_resampled, y_resampled):
                    ...
                    y_pred_inner = clf.predict_proba(X_valid_inner_scaled)[:, 1]
                    auc_scores.append(roc_auc_score(y_valid_inner, y_pred_inner))
            ...
            best_model = RandomForestClassifier(**best_params, random_state=1, n_jobs=6)
