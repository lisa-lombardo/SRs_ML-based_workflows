        ...
        for outer_train_idx, outer_test_idx in outer_cv.split(X, y):
            ...
            def objective(trial, X_resampled, y_resampled):
                ...
                etc = ExtraTreesClassifier(
                    ...
                    bootstrap=bootstrap, class_weight=class_weight, random_state=1, n_jobs=6
                )
                ...
                for inner_train_idx, inner_test_idx in inner_cv.split(X_resampled, y_resampled):
                    ...
                    y_pred_inner = etc.predict_proba(X_valid_inner_scaled)[:, 1]
            ...
            best_model = ExtraTreesClassifier(**best_params, random_state=1, n_jobs=6)
