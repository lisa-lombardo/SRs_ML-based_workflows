...
def main():
    parser = argparse.ArgumentParser(description="Train multiclass ExtraTrees model with cross-validation")
    ...
    def objective(trial):
        ...
        auc_scores = cross_val_score(pipeline, X, y, cv=stratkfold, scoring='roc_auc_ovr_weighted', n_jobs=3)
    ...
    print(f"Final pipeline saved to {models_dir}/et_final_pipeline.joblib")
